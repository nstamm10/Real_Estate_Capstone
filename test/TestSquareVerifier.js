...
const proof_json = {
  "proof": {
    ...
    "inputs": [ Web3.toBN(proof_file.proof.inputs[0]).toString(), Web3.toBN(proof_file.proof.inputs[1]).toString()]
  }
}
...
contract("verifier", accounts => {
    ...
    it("Test verification with correct proof", async function () {
        let verify = await Verifier.verifyTx(
            proof_json.proof.a,
            proof_json.proof.b,
            proof_json.proof.c,
            proof_json.proof.inputs,
            {from: accounts[0]}
        )
